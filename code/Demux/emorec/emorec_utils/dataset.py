...
class MeasuringHateSpeechDataset(EmotionDataset, ABC):
    ...
    identities = ['race', 'origin', 'women', 'transgender', 'sexuality', 'disability', 'muslim', 'jewish']
    hate_categories = ['negative', 'disrespectful', 'insult', 'attack', 'hatespeech']

    for identity in identities:
        for hate_category in hate_categories:
            _emotions += [f'{identity}_{hate_category}']
    ...
    def load_dataset(self) -> Tuple[List[str], torch.Tensor]:
        ...
        df = pd.read_csv('./mhs_aggregated_labels_combined_categories.csv')
